...
import TransactionSearchForm from './TransactionsSearchForm'
...
describe("TransactionSearchForm", () => {
    ...
    it('renders as expected', () => {
      ...
      component = shallow(<TransactionSearchForm transactions= {transactions}/> );
      expect(component).toMatchSnapshot();
   });
   it('should render a form ', () => {
    component = mount(<TransactionSearchForm transactions= {transactions}/> );
